...
public class PresenterQuestionViewpagerAllQuestions {
    private static final int QUESTIONS_AMOUNT = 221;
    private static final int QUESTIONS_NEEDED = 221;
    ...
    public PresenterQuestionViewpagerAllQuestions (IQuestionViewpager iQuestionViewpager) {
