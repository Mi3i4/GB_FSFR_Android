...
import com.finapp.gramfin.finapp.feature.question_viewpager.QuestionViewpagerFragmentAllQuestions;
...
public class PresenterChapterSelectionAllQuestions {

    private IFragmentChooseChapter ifragmentChooseChapter;
    private List<ModelChapter> listChapters = new ArrayList<>();


    public PresenterChapterSelectionAllQuestions (IFragmentChooseChapter ifragmentChooseChapter) {
    ...
    public void callBackIdModelChapters(int id) {
        ...
        switch (id) {
            case 0:
                FragmentRouter.getInstance().placeFragment(QuestionViewpagerFragmentAllQuestions.class);
                break;
            default:
